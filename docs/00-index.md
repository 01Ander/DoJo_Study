...
Manifiesto fundacional. Inmersión Total, Empleabilidad Activa, Gate de Búsqueda Paralela, Modo Operador vs. Arquitecto y principios de ingeniería.
...
Arquitectura pedagógica estándar: `lore/` (teoría), `quests/` (laboratorios), `grimoire.md` (síntesis Feynman) y `rite/` (proyecto integrador).

### 8. Syllabus Maestro: Fase 2 (Post-Empleo & Especialización)
**→ [`08-syllabus-post-empleo-fase2.md`](08-syllabus-post-empleo-fase2.md)**  
...
Este índice opera como la puerta de acceso canónica del ecosistema DoJo.
