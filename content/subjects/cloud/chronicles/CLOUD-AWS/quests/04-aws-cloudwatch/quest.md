...
> **Scaffolding Nivel 5 (Autónomo):** Aquí aplicamos Spaced Repetition (repasar conceptos de Lambda) y autonomía completa. Escribe el script desde cero en `solution.py`. Los tests interceptarán tus logs para asegurar que estés usando el módulo `logging` y no meros `print()`.
